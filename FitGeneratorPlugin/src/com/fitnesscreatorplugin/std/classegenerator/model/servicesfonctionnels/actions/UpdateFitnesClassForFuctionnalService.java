package com.fitnesscreatorplugin.std.classegenerator.model.servicesfonctionnels.actions;
...
public class UpdateFitnesClassForFuctionnalService extends FitnesClassForFunctionnalService
{
		...
		if (actualpackage.contains(".services.")){
	     ...
	     // recuperation de la liste des parametres de la methode dans une chaine pour l'utiliser aprés lors de l'appel de service 
	      ...
	      ////
	            ...
	            // traitement de l'entité à m ; extraction de ses parametres avec leurs types
	      //extractFieldsFromInterface.getFields(list2.getReturnType());
	           ...
	           // declaratiob des attributs selectedClass,entityFact,BEANID, entity , is created , errorcode
	            ...
	            System.out.println("getting the factory of"+list2.getReturnType().getPackage().toString().substring(8));
