package com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.controller.dispatcher;
...
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesfonctionnels.actions.CreateFitnesClassForFuctionnalService;
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesfonctionnels.actions.DeleteFitnesClassForFuctionnalService;
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesfonctionnels.actions.UpdateFitnesClassForFuctionnalService;
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesunitaires.actions.CreateFitnesClassForUnitaryService;
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesunitaires.actions.DeleteFitnesClassForUnitaryService;
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesunitaires.actions.FindFitnesClassForUnitaryService;
import com.linedata.ekip.fitnesscreatorplugin.std.classegenerator.model.servicesunitaires.actions.UpdateFitnesClassForUnitaryService;
import com.linedata.ekip.fitnesscreatorplugin.std.shared.devutils.config.model.jaxb.unmarshall.Service;
import com.linedata.ekip.fitnesscreatorplugin.std.shared.devutils.config.xml.unmarshalling.MarshalCatalogueFile;
import com.linedata.ekip.fitnesscreatorplugin.std.shared.devutils.loader.CustomClassLoader;
import com.linedata.ekip.fitnesscreatorplugin.std.shared.devutils.service.identity.ServiceIdentifier;
