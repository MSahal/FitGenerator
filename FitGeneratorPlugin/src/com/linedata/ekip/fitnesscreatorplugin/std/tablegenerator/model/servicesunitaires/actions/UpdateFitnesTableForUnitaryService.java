...
public class UpdateFitnesTableForUnitaryService extends FitnesTableForUnitaryService{
	/**
	...
	private UpdateFitnesTableForUnitaryService() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public static UpdateFitnesTableForUnitaryService getInstance()
	{
	
		return new UpdateFitnesTableForUnitaryService();
	}
	...
	String toUpperCaseFirstChar(String s)
	   ...
	   public void generateContent(Class<?> TS, Method list2,  CustomClassLoader loader, String dir,boolean open) throws IOException, JClassAlreadyExistsException
	   {
	      ...
	      System.out.println("**********generation des tableaux pour la mathode update*************");
